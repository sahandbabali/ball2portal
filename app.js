...
function preload() {
  woodbackground = loadImage('https://github.com/sahandbabali/ball2portal/blob/main/wood.jpg');
  ballbg = loadImage('/https://github.com/sahandbabali/ball2portal/blob/main/ball.png');
}
